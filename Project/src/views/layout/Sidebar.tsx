              ...
              <ul className="menu">
                ...
                <li className="sidebar-item  has-sub">
                  ...
                  <ul className="submenu ">
                    ...
                    <li className="submenu-item  ">
                      <a href="extra-component-date-picker.html" className="submenu-link">
                        Date Picker
                      </a>
                    </li>
                    ...
                    <li className="submenu-item  ">
                      <a href="extra-component-sweetalert.html" className="submenu-link">
                        Sweet Alert
                      </a>
                    </li>

                    <li className="submenu-item  ">
                      <a href="extra-component-toastify.html" className="submenu-link">
                        Toastify
                      </a>
                    </li>
                ...
                <li className="sidebar-item  has-sub">
                  ...
                  <ul className="submenu ">
                    ...
                    <li className="submenu-item  ">
                      <a href="layout-vertical-1-column.html" className="submenu-link">
                        1 Column
                      </a>
                    </li>
                ...
                <li className="sidebar-item  has-sub">
                  ...
                  <ul className="submenu ">
                    ...
                    <li className="submenu-item  ">
                      <a href="form-element-input-group.html" className="submenu-link">
                        Input Group
                      </a>
                    </li>
                ...
                <li className="sidebar-item  has-sub">
                  ...
                  <ul className="submenu ">
                    <li className="submenu-item  ">
                      <a href="ui-icons-bootstrap-icons.html" className="submenu-link">
                        Bootstrap Icons{" "}
                      </a>
                    </li>
