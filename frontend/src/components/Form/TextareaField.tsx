...
const TextareaField = ({ label, formHook, errorMessage, placeholder, icon }: FormInputProps) => {
  return (
    <>
      ...
      <div className="col-md-8 mb-3">
        <div className="form-group has-icon-left mb-0">
          <div className="position-relative">
            <textarea {...formHook} id={formHook.name} className="form-control" placeholder={placeholder}></textarea>
